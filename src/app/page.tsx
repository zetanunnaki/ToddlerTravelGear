...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className="hero-bg dark:bg-navy-900 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-28">
          <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold px-7 py-3.5 rounded-full border border-gray-200 dark:border-gray-700 hover:border-teal-300 hover:bg-teal-50 dark:hover:bg-teal-900/30 transition-all text-sm"
                >
            ...
            <div className="relative hidden md:block">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-teal-900/10">
                <Image
                  src="/images/hero-family-airport.png"
                  alt="Parent and toddler walking through an airport terminal"
                  width={640}
                  height={427}
              ...
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-teal-100 rounded-full opacity-50 -z-10" />
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-amber-100 rounded-full opacity-50 -z-10" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-navy-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-navy-900 dark:text-white mb-3">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link
              href="/best"
              className="group bg-gradient-to-br from-teal-50 to-white dark:from-teal-900/30 dark:to-gray-800/50 rounded-2xl p-8 border border-teal-100/50 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-14 h-14 bg-teal-100 rounded-2xl flex items-center justify-center mb-5 group-hover:bg-teal-600 group-hover:scale-110 transition-all duration-300" aria-hidden="true">
            ...
            <Link
              href="/guides"
              className="group bg-gradient-to-br from-amber-50 to-white dark:from-amber-900/20 dark:to-gray-800/50 rounded-2xl p-8 border border-amber-100/50 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-14 h-14 bg-amber-100 rounded-2xl flex items-center justify-center mb-5 group-hover:bg-amber-500 group-hover:scale-110 transition-all duration-300" aria-hidden="true">
            ...
            <Link
              href="/guides/toddler-packing-list"
              className="group bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-900/20 dark:to-gray-800/50 rounded-2xl p-8 border border-emerald-100/50 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-14 h-14 bg-emerald-100 rounded-2xl flex items-center justify-center mb-5 group-hover:bg-emerald-600 group-hover:scale-110 transition-all duration-300" aria-hidden="true">
      ...
      {/* Latest Best Picks */}
      <section className="bg-cream-200 dark:bg-navy-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <div className="flex items-end justify-between mb-10">
            <div>
              <span className="text-xs font-bold text-teal-600 uppercase tracking-widest">Roundups</span>
              <h2 className="font-display text-3xl sm:text-4xl font-bold text-navy-900 dark:text-white mt-1">
                Latest Best Picks
              </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {roundups.map((item) => (
                <Link
                  ...
                  className="group block bg-white dark:bg-gray-800/50 rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                >
                  ...
                  <div className="p-5">
                    <h3 className="font-display font-bold text-navy-900 dark:text-white mb-2 leading-snug group-hover:text-teal-700 transition-colors">
                      {item.meta.title}
                    </h3>
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {reviews.map((item) => (
                <Link
                  ...
                  className="group block bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 hover:border-teal-100 transition-all duration-300"
                >
                  <div className="flex items-center gap-2 mb-3">
                    <span className="inline-block text-xs font-semibold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-full">
                      {item.meta.category}
                    </span>
                    <span className="text-xs text-gray-500">{item.meta.readingTime}</span>
                  </div>
                  <h3 className="font-display font-bold text-navy-900 dark:text-white mb-2 group-hover:text-teal-700 transition-colors leading-snug">
                    {item.meta.title}
                  </h3>
                  <p className="text-sm text-gray-500 line-clamp-2 mb-3">
                    {item.meta.description}
      ...
      {/* Guides */}
      <section className="bg-gray-50 dark:bg-navy-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <div className="flex items-end justify-between mb-10">
            <div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {guides.map((item) => (
                <Link
                  ...
                  className="group flex items-start gap-4 bg-white dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 hover:border-teal-100 transition-all duration-300"
                >
                  <div className="w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-amber-100 transition-colors" aria-hidden="true">
                    <svg className="w-6 h-6 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                  </div>
                  <div className="min-w-0 flex-1">
                    <h3 className="font-display font-bold text-navy-900 dark:text-white mb-1 group-hover:text-teal-700 transition-colors leading-snug">
                      {item.meta.title}
                    </h3>
