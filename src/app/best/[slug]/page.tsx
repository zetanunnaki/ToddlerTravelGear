...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: item.meta.featuredImage
    ...
    twitter: {
      ...
      title: item.meta.seoTitle || item.meta.title,
      description: item.meta.description,
      images: item.meta.featuredImage ? [item.meta.featuredImage] : [],
    },
  };
}
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <header className="mb-10">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-5 text-sm text-gray-400">
