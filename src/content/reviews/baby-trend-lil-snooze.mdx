...
description: "Honest Baby Trend Lil' Snooze Deluxe III review — bassinet, changing table, and full-size playard for $124."
...
The mesh sides provide ventilation and visibility. You can see the baby from across the room, and airflow is good even in warm rooms. The padded floor mat is thin — as all playard mattresses are for safety reasons — but adequate. We never added supplemental padding, which is important because adding mattresses or blankets to a playard is a suffocation risk per [AAP safe sleep guidelines](https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/A-Parents-Guide-to-Safe-Sleep.aspx).
...
<FAQ items={[
  ...
  { question: "Can you use the Baby Trend Lil' Snooze for overnight sleep?", answer: "Yes, the playard meets CPSC standards for infant sleep. Use the bassinet for newborns up to 15 pounds and the playard floor for older babies and toddlers. Never add extra bedding or padding. See CPSC crib safety guidelines at cpsc.gov for more details." },
