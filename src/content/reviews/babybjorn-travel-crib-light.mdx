...
description: "Honest BabyBjorn Travel Crib Light review — the fastest setup in travel cribs, premium build quality, how it compares to the Guava Lotus, and whether $200 is justified."
...
The BabyBjorn is rated from birth, and the mattress quality makes it genuinely suitable for young babies. The firm-but-cushioned surface aligns with safe sleep guidelines while providing enough comfort that our baby settled without prolonged fussing. The mesh sides provide airflow, which matters for regulating temperature — hotel rooms are notoriously inconsistent with heating and cooling, and a breathable crib helps your baby maintain comfortable body temperature.
...
## BabyBjorn vs Guava Lotus: The Comparison That Matters
...
Always use only the mattress that comes with the BabyBjorn Travel Crib Light. Do not add aftermarket mattresses, extra padding, pillows, blankets, or soft bedding. The included mattress is specifically designed and safety-tested for this crib — adding anything to it creates gaps or soft surfaces that pose suffocation risks. When setting up the crib, ensure you hear all four locking clicks, confirming the frame is fully open and rigid. Give the frame a firm push to verify stability before placing your child inside. Follow the manufacturer's weight and age limits: the crib is rated from birth to approximately age 3 or until your child can climb out, whichever comes first.
</SafetyNote>
