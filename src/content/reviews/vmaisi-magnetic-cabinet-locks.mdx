...
Cabinet locks are not a substitute for removing dangerous items from reach, as noted in the [AAP's baby-proofing guidelines](https://www.healthychildren.org/English/safety-prevention/at-home/Pages/default.aspx). Before relying on any lock, move cleaning chemicals, medications, sharp objects, and plastic bags to a high shelf or completely out of the space. The most common poisoning incidents in vacation rentals involve products left under kitchen and bathroom sinks by property owners. Check every cabinet at eye level and below, even ones you plan to lock. Locks can fail. Height cannot.
