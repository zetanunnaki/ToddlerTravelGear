...
description: "Honest Graco Slimfit 3-in-1 review after two years of daily use — slim profile for three-across seating, rear-facing through booster conversion, and more."
category: "Car Seats"
type: "review"
...
Installation uses standard LATCH connectors or the vehicle seatbelt. There is no self-tensioning system — you manually tighten the LATCH straps and check for [less than one inch of movement at the belt path](https://www.nhtsa.gov/equipment/car-seats-and-booster-seats). This requires some physical effort and patience. Our initial rear-facing installation took about fifteen minutes to get properly tight.
...
<SafetyNote>
Ensure proper LATCH or seatbelt installation with less than one inch of movement at the belt path. In three-across configurations, verify that all seats are properly secured and no installation is compromising an adjacent seat. Rear-face as long as possible within the seat's 40-pound rear-facing limit, per [AAP car seat guidelines](https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Car-Safety-Seats-Information-for-Families.aspx). Register your seat at gracobaby.com for recall notifications. Replace the seat after any crash, even a minor one.
</SafetyNote>
...
<FAQ items={[
  ...
  { question: "Is the Graco Slimfit FAA approved?", answer: "Yes, the Slimfit is [FAA approved for use on aircraft](https://www.faa.gov/travelers/fly_children). At 18 pounds it is carriable but not light. For frequent flying, a dedicated travel seat like the Cosco Scenera Next at 11 pounds is more practical." }
]} />
