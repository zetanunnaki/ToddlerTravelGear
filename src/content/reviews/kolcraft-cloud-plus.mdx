...
description: "Honest Kolcraft Cloud Plus review after a year of daily use — reclining seat, storage basket, parent and child trays, all under $90. How it performed at airports, parks, and everywhere in between."
...
- **Ultralight minimalists** — at 12 lbs, it is heavier than true travel strollers like the gb Pockit (9.5 lbs) or BabyZen YOYO2 (13.6 lbs with a much more compact fold)
...
**Gate-checking without stress.** We gate-checked the Cloud Plus on four flights. Each time, we folded it at the jet bridge, handed it over, and retrieved it at our destination without worrying. If it came back scratched or damaged, we were out $88 — not $500. It has come back fine every time, but the peace of mind matters.
...
**vs. BabyZen YOYO2 ($550):** The YOYO2 is the luxury option with one-hand fold, cabin-bag compatibility, and premium construction. It is a genuinely better stroller. But it costs six times more. The Cloud Plus provides 80 percent of the daily utility at 16 percent of the price.

<SafetyNote>
Always engage the brakes when the stroller is stationary, especially on slopes. Use the five-point harness every time, even for short rides. Check that the tray attachment is secure before placing food or drinks. The stroller is rated for children 6 months and older — do not use with infants who cannot sit unassisted. Never hang heavy bags from the handles, as this can cause the stroller to tip backward.
</SafetyNote>
