...
featuredImage: "/images/products/portable-sound-machine-clip.jpg"
productIds:
...
<SafetyNote>
Place the sound machine at least 7 inches from your baby's head when clipped to the crib rail — clip it to the far end of the rail, not directly next to where your baby's head rests. Keep the volume at or below 50 decibels at the baby's ear level per [AAP guidelines](https://www.healthychildren.org/English/ages-stages/baby/sleep/Pages/A-Parents-Guide-to-Safe-Sleep.aspx). Never place the machine inside the crib, in the crib bedding, or where the baby can pull it into the crib. Secure the clip firmly and check that the machine cannot be dislodged by a child pulling on it. The USB-C charging cable should never be in the crib area during sleep.
</SafetyNote>
