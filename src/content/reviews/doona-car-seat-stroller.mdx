...
The critical question is not whether it works well. It does. The question is whether you will get enough use out of it before your baby outgrows the 35-pound rear-facing limit — and per [AAP car seat guidelines](https://www.healthychildren.org/English/safety-prevention/on-the-go/Pages/Car-Safety-Seats-Information-for-Families.aspx), children should remain rear-facing as long as possible — which for most children happens somewhere between 12 and 18 months. At $650, the Doona needs to deliver enough value in that window to justify a price that could buy you a solid infant car seat and a dedicated travel stroller with money to spare.
...
One important note: the Doona does not fit in airplane overhead bins. It is a car seat, and it is sized like a car seat. This is not a carry-on item. If you want to use a car seat on the plane (which the [FAA recommends for infants](https://www.faa.gov/travelers/fly_children)), the Doona is FAA-approved and fits in a standard economy seat. If you prefer to fly with baby on your lap, you are gate-checking the Doona.
...
The Doona meets [CPSC safety requirements](https://www.cpsc.gov/Safety-Education/Safety-Guides/Kids-and-Babies/Strollers) for strollers and all applicable federal motor vehicle safety standards for car seats. Before installing the Doona in any vehicle — whether on the base or using the seatbelt — always verify that both rear wheels and the front wheels are fully retracted into the car seat body. Partially extended wheels prevent the car seat from sitting flat and properly secured, which compromises crash protection. After retracting the wheels, press firmly on each wheel housing to confirm it is fully locked in the retracted position. This becomes especially important during rushed transitions in rideshares and taxis where speed can cause you to skip this check. Take the extra three seconds. Every time.
</SafetyNote>
