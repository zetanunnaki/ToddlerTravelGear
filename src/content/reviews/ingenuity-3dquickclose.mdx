...
We were standing in the Target stroller aisle, doing the thing every budget-conscious parent does: staring at a $549 travel stroller we wanted, then looking at our bank account, then back at the stroller, then back at the bank account. The BABYZEN YOYO2 is a magnificent stroller. It is also, at $549, a car payment. We needed something that folded compact enough for air travel, weighed little enough to carry through an airport, and cost little enough that we would not feel physical pain when gate-checking it into the cargo hold where luggage handlers treat everything like a rugby ball.
...
The folded size is the stroller's calling card. At roughly 21 x 18 x 8 inches, it approaches — though does not quite match — the BABYZEN YOYO2's folded dimensions. We have fit the 3Dquickclose in the overhead bin on Boeing 737s (Delta and Southwest) and Airbus A320s (JetBlue). On the 737, it was a snug fit that required some wiggling. On the A320, it fit with a bit more room. On smaller regional jets (CRJ-200), it did not fit, and we gate-checked. The overhead bin fit is not guaranteed on every aircraft, but it works on most standard domestic narrowbody planes.
...
**vs. BABYZEN YOYO2 ($549):** The YOYO2 is better in every measurable category: ride quality, build quality, fold compactness, canopy, and resale value. It should be — it costs 5.7 times more. The 3Dquickclose achieves roughly 80 percent of the YOYO2's travel functionality for 17 percent of the price. For families who fly frequently and want the best, the YOYO2 is the answer. For families who fly occasionally and want good enough, the 3Dquickclose is the smarter financial decision.
...
The compromises are clear: rougher ride, smaller basket, limited recline, moderate build quality. If those compromises bother you, spend more on a YOYO2 or a Bugaboo Butterfly. If those compromises are acceptable in exchange for saving $450, the 3Dquickclose is the stroller to buy. After seven flights and six months of use, we are still using the $96 stroller. And every time we see someone wrestling a $500 stroller at the gate, we feel a little smug about our side salad purchase.
