...
featuredImage: "/images/products/jl-childress-gate-check-bag.jpg"
productIds:
...
<SafetyNote>
Never place a child inside the gate check bag. Remove all loose items from the stroller before bagging — water bottles, toys, and small items can shift during handling and be lost or become projectiles. Ensure the stroller is fully folded and locked before inserting into the bag. Do not use the bag as a carrying device for the stroller — carry the stroller by its handle with the bag draped over it.
</SafetyNote>
