...
description: "Honest Baby Trend Expedition Jogger review — large all-terrain wheels, lockable front swivel, parent tray with cup holders. How this $128 jogger performed on trails, airports, and daily walks."
...
<SafetyNote>
Always use the 5-point harness when the child is seated. Lock the front wheel before jogging — a swiveling front wheel at jogging speed is dangerous. Engage the parking brake when stationary. Do not jog with infants under 6 months — the impact can affect developing neck and spine. Check tire pressure before every jog — underinflated tires affect handling. Do not exceed the manufacturer's weight limit. Do not hang heavy bags on the handlebar — the higher center of gravity increases tip risk.
</SafetyNote>
