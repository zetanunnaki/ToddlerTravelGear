...
1. Pick your toddler's age below
2. Pick your trip type — beach, winter, camping, city, or road trip
3. Tap items as you pack them — the progress bar tracks what is left
4. Add your own items at the bottom
5. Switch between "By Category" (grouped by type) and "Full List" (everything in order)
6. Hit "Download PDF" for a paper version you can print
