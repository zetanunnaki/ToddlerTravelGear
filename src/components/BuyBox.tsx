...
export function BuyBox({ productId }: BuyBoxProps) {
  ...
  return (
    <div className="border-2 border-teal-200 rounded-2xl p-5 sm:p-6 my-6 bg-gradient-to-b from-teal-50 to-white">
      <div className="flex items-start justify-between gap-2 mb-1">
        <h3 className="font-display font-bold text-gray-900 text-lg">{product.name}</h3>
