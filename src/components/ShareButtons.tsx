...
export function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const links = [
    ...
    },
    {
      ...
      color: "hover:bg-gray-100 hover:text-black hover:border-gray-300",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      color: "hover:bg-teal-50 hover:text-teal-700 hover:border-teal-200",
      icon: (
  ...
  return (
    <div className="flex items-center gap-2 my-8 py-4 border-t border-gray-100">
      <span className="text-sm font-medium text-gray-500 mr-1">Share this article:</span>
      {links.map((link) => (
        <a
          key={link.label}
          href={link.href}
