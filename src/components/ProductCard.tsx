...
export function ProductCard({ productId, badge, reason }: ProductCardProps) {
  ...
  return (
    <div className="border border-gray-200 rounded-2xl p-5 sm:p-6 my-6 bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
      <div className="flex flex-col sm:flex-row gap-5 sm:gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <h3 className="font-display font-bold text-gray-900 text-lg leading-snug">{product.name}</h3>
            {badge && (
